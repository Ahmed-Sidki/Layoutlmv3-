I demonstrate in this mini project the approach I use to solve a data science problem, specifically in the context of deep learning. The task is to detect the total amount (TTC) on a receipt document.
